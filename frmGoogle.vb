...
Friend Class frmGoogle
    ...
    'TODO Fix the "next page of results" link, doesn't work. Alasdair Sep 2020
    ...
    Private mUrls(0 To MAX_NUMBER_LINKS_SUPPORTED - 1) As String
    ...
    Private Sub GoToResult()
        Try
            ...
            Else
                'Call Me.Hide()
                System.Diagnostics.Process.Start(mUrls(lstResults.SelectedIndex))
            End If
        Catch
        End Try
    End Sub
    ...
    Private Sub StartSearch()
        ...
        If txtSearch.Text.Trim <> "" Then
            ...
            If searchString = "Search engine:" Then searchString = "https://www.google.com/search?q="
            searchString = searchString & txtSearch.Text.Replace(" ", "+")
    ...
    Private Sub mWebBrowser_DocumentCompleted(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.WebBrowserDocumentCompletedEventArgs) Handles mWebBrowser.DocumentCompleted
        ...
        ElseIf eventArgs.Url.ToString = "http:///" Then
            'Ignore.
        ElseIf eventArgs.Url.ToString = "https:///" Then
            'Ignore.
        ...
        Else
            ...
            Call mXMLResultsPage.Append("</results>")
            Call resultsDoc.LoadXml(mXMLResultsPage.ToString())
            Call resultsDoc.Save(My.Computer.FileSystem.SpecialDirectories.Temp & "\google_search_results.xml")
            ...
            Else
                mStartAt = mStartAt + NUMBER_RESULTS_ON_GOOGLE_PAGE
